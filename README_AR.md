...
4. شغّل Vesktop من قائمة Start.
5. سجّل الدخول ببيانات Discord الخاصة بك.
...
6. اضغط على زر الطاقة للاتصال تلقائياً، أو:
7. وسّع قائمة المواقع واختر دولة (يُنصح بـ: المملكة المتحدة، ألمانيا، أو هولندا).
8. انتظر حالة "متصل".
9. افتح Discord — يجب أن يعمل فوراً.
